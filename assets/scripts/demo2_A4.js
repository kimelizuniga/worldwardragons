(function (cjs, an) {
	...
	(lib.demo2A4 = function(mode,startPosition,loop) {
				...
				if(dragon.fired == true)
				{
					...
					missileArray.forEach(missile => {
						...
						)
						{
							...
							missile.explosion.y = dragon.fireBall.y + dragon.fireBall.halfWidth;
		...
		this.instance_12 = new lib.enterName();
		this.instance_12.setTransform(362,206);
		...
		this.instance_13 = new lib.homeText();
		this.instance_13.setTransform(423,406,0.873,0.8333);
		...
		this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_16}]}).to({state:[{t:this.background}]},15).wait(10));
